  ...
  template: `
    <main class="flex min-h-screen items-center justify-center p-6">
      <section class="card w-full max-w-md p-8">
        <app-logo />
        <h1 class="mt-10 text-3xl font-extrabold">Recuperar senha</h1>
        <p class="mt-2 text-sm text-slate-500">Informe o e-mail do usuário do tenant para receber o token de redefinição.</p>
